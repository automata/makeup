...
var faceDeformer = function() {
  ...
  this.load = function(element, points, pModel, vertices) {
    ...
    //var makeup = document.getElementById('makeup').getContext('2d');
    //makeup.drawImage(cc.getImageData(minx, miny, width, height));
    //cc.fillStyle = "rgba(200,0,0,0.1)";
    //cc.fillRect(minx+50,miny+50,50,50);

    // var regions = {'upperLip': [44,45,46,47,48,49,50]};

    // // eyebrowns
    // cc.strokeStyle = "hsla(180,40%,20%, 0.5)";
    // cc.lineWidth = 15;
    // cc.lineJoin = cc.lineCap = 'round';
    // cc.shadowBlur = 20;
    // cc.shadowColor = 'rgb(0, 0, 0)';
    // cc.beginPath();
    // for (var i = 15;i < 19;i++) {
    //   cc.lineTo(points[i][0]+minx/width, points[i][1]+miny/height);
    // }
    // cc.stroke();
    // cc.beginPath();
    // for (var i = 19;i < 22;i++) {
    ...
    // // mouth
    // cc.strokeStyle = "hsla(20,80%,10%, 0.4)";
    // cc.lineWidth = 2;
    // cc.lineJoin = cc.lineCap = 'round';
    // cc.shadowBlur = 2;
    // cc.shadowColor = 'rgb(0, 0, 0)';
    // cc.beginPath();
    // for (var i=0; i<regions['upperLip'].length; i++) {
    //   var x = points[regions['upperLip'][i]][0];
    //   var y = points[regions['upperLip'][i]][1];
    //   cc.lineTo(x+minx/width, y+miny/height);
    // }
    // cc.stroke();
